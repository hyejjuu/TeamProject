...
<!-- content -->
<div class="row justify-content-md-center my-5" id="global-content">
	<div class="col">
		...
		<div class="row">
			...
			<div class="text-center">
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="tab-pane fade" id="list-days" role="tabpanel" aria-labelledby="list-days">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
								<label><input type="checkbox" name="three" id="2n1"value="발열">발열</label>
								<label><input type="checkbox" name="three" id="2n2"value="인후통">인후통</label>
								<label><input type="checkbox" name="three" id="2n3"value="설사">설사</label>
								</div>
							</div>
						</fieldset>
					...
					<div class="tab-pane fade" id="list-week" role="tabpanel" aria-labelledby="list-week">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="week" id="3n1"value="약물복용">약물 복용</label>
									<label><input type="checkbox" name="week" id="3n2"value="주사">주사</label>
								</div>
							</div>
						</fieldset>
					...
					<div class="tab-pane fade" id="list-month" role="tabpanel" aria-labelledby="list-month">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="month" id="4n1"value="반복적인 고열, 춥고 떨림, 땀흘림">반복적인 고열, 춥고 떨림, 땀흘림</label>
									<label><input type="checkbox" name="month" id="4n2"value="의료기관에서 단순 감기 이외의 질병 진단 또는 치료">의료기관에서 단순 감기 이외의 질병 진단 또는 치료</label>
									<label><input type="checkbox" name="month" id="4n3"value="시술(내시경, 조직검사, 레이저 시술 등)">시술(내시경, 조직검사, 레이저 시술 등)</label>
									<label><input type="checkbox" name="month" id="4n4"value="외국 여행">외국 여행</label>
									<label><input type="checkbox" name="month" id="4n5"value="치과치료">치과치료</label>
									<label><input type="checkbox" name="month" id="4n6"value="기타">기타</label>
								</div>
							</div>
						</fieldset>
					...
					<div class="tab-pane fade" id="list-months" role="tabpanel" aria-labelledby="list-months">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="months" id="5n1"value="사마귀, 점제거, 피어씽(귀뚫음 등), 문신(반영구화장 포함)">사마귀, 점제거, 피어씽(귀뚫음 등), 문신(반영구화장 포함)</label>
									<label><input type="checkbox" name="months" id="5n2"value="침술, 부항(사혈)">침술, 부항(사혈)</label>
								</div>
							</div>
						</fieldset>
					...
					<div class="tab-pane fade" id="list-year" role="tabpanel" aria-labelledby="list-year">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="year" id="6n1"value="입원">입원</label>
									<label><input type="checkbox" name="year" id="6n2"value="수혈">수혈</label>
									<label><input type="checkbox" name="year" id="6n3"value="수술">수술</label>
									<label><input type="checkbox" name="year" id="6n4"value="경련">경련</label>
									<label><input type="checkbox" name="year" id="6n5"value="예방접종">예방접종</label>
									<label><input type="checkbox" name="year" id="6n6"value="다른 사람이 사용한 주사침에 찔림">다른 사람이 사용한 주사침에 찔림</label>
									<label><input type="checkbox" name="year" id="6n7"value="의식소실">의식소실</label>
									<label><input type="checkbox" name="year" id="6n8"value="마약주사">마약주사</label>
									<label><input type="checkbox" name="year" id="6n9"value="교도소(소년교도소 포함), 구치소 등에 3일 이상 수감">교도소(소년교도소 포함), 구치소 등에 3일 이상 수감</label>
									<label><input type="checkbox" name="year" id="6n10"value="불특정 이성과의 성접촉 또는 남성의 경우 남성과의 성접촉">불특정 이성과의 성접촉 또는 남성의 경우 남성과의 성접촉</label>
									<label><input type="checkbox" name="year" id="6n11"value="기타">기타</label>
								</div>
							</div>
						</fieldset>
					...
					<div class="tab-pane fade" id="list-every" role="tabpanel" aria-labelledby="list-every">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="every" id="7n1"value="암">암</label>
									<label><input type="checkbox" name="every" id="7n2"value="심장질환">심장질환</label>
									<label><input type="checkbox" name="every" id="7n3"value="신장질환">신장질환</label>
									<label><input type="checkbox" name="every" id="7n4"value="간질환">간질환</label>
									<label><input type="checkbox" name="every" id="7n5"value="당뇨">당뇨병</label>
									<label><input type="checkbox" name="every" id="7n6"value="혈액질환">혈액질환(혈우병, 적혈구증다증 등)</label>
									<label><input type="checkbox" name="every" id="7n7"value="호흡기질환">호흡기질환</label>
									<label><input type="checkbox" name="every" id="7n8"value="피부질환">피부질환(건선 등)</label>
									<label><input type="checkbox" name="every" id="7n9"value="알코올 또는 마약 중독">알코올 또는 마약 중독</label>
									<label><input type="checkbox" name="every" id="7n10"value="정신질환">정신질환</label>
									<label><input type="checkbox" name="every" id="7n11"value="경련성질환">경련성 질환</label>
									<label><input type="checkbox" name="every" id="7n12"value="자가면역질환">자가면역질환(류마티스 등)</label>
									<label><input type="checkbox" name="every" id="7n13"value="장기이식">장기이식(신장, 간장, 췌장, 심장, 폐, 골수, 안구 등)</label>
									<label><input type="checkbox" name="every" id="7n14"value="기타">기타</label>
								</div>
							</div>
						</fieldset>
					...
					<div class="tab-pane fade" id="list-drug" role="tabpanel" aria-labelledby="list-drug">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="drug" id="8n1"value="건선치료제(에트레티네이트, 아시트레틴)">건선치료제(에트레티네이트, 아시트레틴)</label>
									<label><input type="checkbox" name="drug" id="8n2"value="소에서 유래한 인슐린">소에서 유래한 인슐린</label>
									<label><input type="checkbox" name="drug" id="8n3"value="전립선치료제(두타스테라이드, 피나스테라이드)">전립선치료제(두타스테라이드, 피나스테라이드)</label>
									<label><input type="checkbox" name="drug" id="8n4"value="탈모증 치료제(피나스테라이드)">탈모증 치료제(피나스테라이드)</label>
									<label><input type="checkbox" name="drug" id="8n5"value="뇌하수체 유래 성장 호르몬">뇌하수체 유래 성장 호르몬</label>
									<label><input type="checkbox" name="drug" id="8n6"value="여드름치료제(이소트렌티노인)">여드름치료제(이소트렌티노인)</label>
									<label><input type="checkbox" name="drug" id="8n7"value="기타">기타</label>
							</div>
						</fieldset>
						<textarea class="form-control m-3" name="drug_t" id="text8" rows="3" placeholder="상세내용을 입력해 주세요"></textarea>
					</div>
					
					<div class="tab-pane fade" id="list-disease" role="tabpanel" aria-labelledby="list-disease">
						...
						<fieldset class="form-group">
							<div class="col-sm-3 text-start">
								...
								<div class="form-check m-3">
									<label><input type="checkbox" name="infectious" id="9n1"value="간염">간염(B형, C형 등)</label>
									<label><input type="checkbox" name="infectious" id="9n2"value="에이즈">에이즈</label>
									<label><input type="checkbox" name="infectious" id="9n3"value="말라리아">말라리아</label>
									<label><input type="checkbox" name="infectious" id="9n4"value="성병">성병(임질, 매독 등)</label>
									<label><input type="checkbox" name="infectious" id="9n5"value="한센병">한센병</label>
									<label><input type="checkbox" name="infectious" id="9n6"value="바베시아증">바베시아증</label>
									<label><input type="checkbox" name="infectious" id="9n7"value="샤가스병">샤가스병</label>
									<label><input type="checkbox" name="infectious" id="9n8"value="변종 크로이츠펠트-야콥병(vCJD)">변종 크로이츠펠트-야콥병(vCJD)</label>
									<label><input type="checkbox" name="infectious" id="9n9"value="브루셀라증">브루셀라증</label>
									<label><input type="checkbox" name="infectious" id="9n10"value="기타">기타</label>
								</div>
							</div>
						</fieldset>
