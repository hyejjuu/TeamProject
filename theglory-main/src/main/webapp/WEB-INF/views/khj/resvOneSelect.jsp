...
<div class="row">
	<div  id="locationName" class="col text-center mt-5 fs-5 fw-bold">${locationName }</div>
</div>
<div class="row">
	<div class="col-2"></div>
	<div class="col">
		...
		<form id="reservationChk" name="reservationChk"
			...
			<input type="hidden" name="locationNo" id="locationNo" value="${locationNo}">
...
<script>
	...
	function reservationList(selectedDate) { 
		...
		$.ajax({
			...
			"data": {"reservationDate": selectedDate, "locationNo": locationNo},
			"dataType": "json",
			"type": "post",
	...
	$(function() {		
		...
		$(document).on("click", ".donationRadio", function() {
		...
		$("#reservationChk").on("submit", function(e) {			
			...
			if($("#reservationTime").val() == "" || $("#donationTypeNo").val() == "") {
				alert("예약 시간과 헌혈 유형을 선택해 주세요");
				return false;
			}
