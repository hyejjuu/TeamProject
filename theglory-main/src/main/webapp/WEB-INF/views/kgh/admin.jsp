...
function FnMChart() {
    ...
    let chartConfig = {
      ...
      graphset: [{
        ...
        plot: {
          tooltip: {
            text: '<span style="color:%color">회원성별 : %t</span><br><span style="color:%color">회원수 : %v명</span>',
            anchor: 'c',
            backgroundColor: 'none',
            borderWidth: '0px',
            fontSize: '16px',
...
function AreaChart(){		
	 ...
	 ZC.LICENSE = ["569d52cefae586f634c54f86dc99e6a9", "b55b025e438fa8a98e32482b5f768ff5"]; // CHART CONFIG
	  ...
	  let chartConfig = {
	    ...
	    source: {
	      text: 'Source: https://stat.kosis.kr',
	      fontColor: '#8e99a9',
	      fontFamily: 'Open Sans',
	      textAlign: 'left'
	    },
...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="#" class="nav-link text-white" onclick="showChart()">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#speedometer2"/></svg>
          Dashboard
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white" onclick="showCustomer()">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
           회원관리
        </a>
      </li>
       <li>
        <a href="#" class="nav-link text-white" onclick="showReservation()">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
          예약관리
        </a>
      </li>
       <li>
        <a href="#" class="nav-link text-white" onclick="showMatching()">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#people-circle"/></svg>
          게시판 관리
        </a>
      </li>
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        <img src="resources/img/admin.jpeg" alt="" width="32" height="32" class="rounded-circle me-2">
        <strong>admin</strong>
      </a>
      <ul class="dropdown-menu dropdown-menu-dark text-small shadow">
        <li><a class="dropdown-item" href="#">whatthef</a></li>
...
function showChart() {
    ...
    xhr.onreadystatechange = function() {
        ...
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            var pathContent = xhr.responseText; 
            
            document.getElementById('content').innerHTML = pathContent;
...
function showReservation() {
    ...
    var xhr = new XMLHttpRequest();    
    xhr.open("GET", "reservationMG", true);
    var selectContainer = document.getElementById("selectContainer");
    selectContainer.style.display = "none";
...
function handleChange() {
  ...
  if (selectedOption === "연령별") {
    showChart();
  } else if (selectedOption === "장소") {
	showAreaChart();
  } else if (selectedOption === "남녀") {
    showBalance();
  }  
  else {
    showNotification();
